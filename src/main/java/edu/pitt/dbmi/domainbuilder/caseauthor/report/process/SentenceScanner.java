...
package edu.pitt.dbmi.domainbuilder.caseauthor.report.process;
...
import edu.pitt.dbmi.domainbuilder.caseauthor.report.ReportData;
import edu.pitt.dbmi.domainbuilder.caseauthor.report.ReportDocument;
...
public class SentenceScanner implements Runnable {
	...
	private Sentence parseSentence(Sentence s) throws Exception {
		return (s == null)?null:textTools.parseSentence(s);
	}
	...
	*/
	...
	private void processSentence(Sentence sentence) throws Exception{
		...
		UIHelper.debug("Setence: \""+sentence.getTrimmedString()+"\""); //+sentence.getSpan()
