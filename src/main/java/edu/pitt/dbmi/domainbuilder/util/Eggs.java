...
public class Eggs {
    private static String dinoImg = "/icons/DrTrex.gif";
    private static String dinoRun = "/icons/dino";
    private static String nerdDoctor = "/icons/protege_md.gif";
    private static String nerdTeacher = "/icons/protege_nerd.gif";
    ...
    public static void processText(String str){
       if(str.matches(DR_TREX)){
           dinoRun(DomainBuilder.getInstance().getFrame());
       }else if(str.matches(CURSES)){
           dontCurse(DomainBuilder.getInstance().getFrame());
       }else if(str.matches(DINO_RUN)){
           dinoRun2(DomainBuilder.getInstance().getFrame());
       }else if(str.matches(NERDS)){
           nerdRun(DomainBuilder.getInstance().getFrame());
       }
    }
    ...
    // dino that is running
    private static void dinoRun(JFrame frame){
    ...
    // dino that is running
    private static void nerdRun(JFrame frame){
        if(frame == null)
            return;
    ...
    // dino that is running
    private static void dinoRun2(JFrame frame){
        final Dimension size = frame.getSize();
        if(frame == null)
            return;
    ...
    public static void main(String args[]){
        ...
        frame.getContentPane().add(new JTextArea(50,100));
        frame.pack();
